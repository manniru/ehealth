...
if(request.getParameter("submit") != null) {
	...
	System.out.println(patientid+"=="+ptype+"=="+reason);
	...
	try {
			PreparedStatement ps = cn.prepareStatement("INSERT INTO permission (pid, ptype, reasons) VALUES(?, ?, ?)");
								...
								<div class="row">
									<div class="12u">
									 ...
									 <table width="200" border="1" cellspacing="1" cellpadding="1">
										      <tr>
										        <td>Patient ID:</td>
										        <td><input name="patientid" type="text" disabled value='<%= patientid %>'></td>
									          </tr>
										      <tr>
