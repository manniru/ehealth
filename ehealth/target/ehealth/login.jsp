...
try {
	...
	ResultSet rs2 = cn.createStatement().executeQuery("SELECT * FROM patient WHERE uid="+userid); rs2.next();
	...
	session.setAttribute("patientid", rs2.getString("id"));
	session.setAttribute("fullname", rs2.getString("fullname"));
